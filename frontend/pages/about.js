                                ...
                                <div className="col-lg-4 col-sm-6">
                                    <div className="about-text">
                                        ...
                                        <ul className="features-list">
                                            <li><i className='bx bx-check'></i> People like CatsHardware</li>
                                            <li><i className='bx bx-check'></i> World's finest CatsHardware</li>
                                            <li><i className='bx bx-check'></i> The original CatsHardware</li>
                                            <li><i className='bx bx-check'></i> We trust CatsHardware</li>
                                        </ul>
                                    </div>
                                </div>
