                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="single-gallery-item">
                                ...
                                <div className="gallery-content">
                                    ...
                                    <h3>Gildan LUMBER Crew T-Shirt</h3>
                                </div>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="single-gallery-item">
                                ...
                                <div className="gallery-content">
                                    <span>T-SHIRT</span>
                                    <h3>Yidarton POWER TOOLS Comfy</h3>
                                </div>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="single-gallery-item">
                                ...
                                <div className="gallery-content">
                                    <span>TWIST SHIRT</span>
                                    <h3>Sunnyme POWER TOOLS Ponchos</h3>
                                </div>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="single-gallery-item">
                                ...
                                <div className="gallery-content">
                                    <span>T-SHIRT</span>
                                    <h3>POWER TOOLS Modern-Skinny</h3>
                                </div>
