                                ...
                                <div className={classNameOne} id="navbarSupportedContent">
                                    <ul className="navbar-nav">
                                            ...
                                            <ul className="dropdown-menu">
                                                <li className="nav-item">
                                                    <Link href="/" activeClassName="active">
                                                        <a className="nav-link">Tools Page One</a>
                                                    </Link>
                                                </li>

                                                <li className="nav-item">
                                                    <Link href="/fashion-style-two" activeClassName="active">
                                                        <a className="nav-link">Tools Page Two</a>
                                                    </Link>
                                                </li>

                                                <li className="nav-item">
                                                    <Link href="/fashion-style-three" activeClassName="active">
                                                        <a className="nav-link">Too Three</a>
                                                    </Link>
                                                </li>
                                            ...
                                            <ul className="dropdown-menu">
                                                <li className="nav-item">
                                                    <div className="container">
                                                        <div className="row">
                                                            <div className="col">
                                                                <h6 className="submenu-title">Shop Tool Category</h6>
                                        ...
                                        <li className="nav-item megamenu">
                                            <Link href="#">
                                                <a className="nav-link">
                                                    POWER TOOLS <i className='bx bx-chevron-down'></i>
                                                </a>
                                            </Link>
                                        ...
                                        <li className="nav-item megamenu">
                                            <Link href="#">
                                                <a className="nav-link">
                                                    LUMBER <i className='bx bx-chevron-down'></i>
                                                </a>
                                            </Link>
