        ...
        return __jsx("div", {
          ...
          onClick: function onClick(e) {
            ...
            axios__WEBPACK_IMPORTED_MODULE_15___default.a.post('http://localhost:4000/admin/products').then(function (data) {
              res.console.log('Product Successfully added!', data);
            });
