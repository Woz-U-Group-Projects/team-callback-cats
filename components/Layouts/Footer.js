                    ...
                    <div className="footer-bottom-area">
                        <div className="row align-items-center">
                            <div className="col-lg-6 col-md-6">
                                <p>
                                    Copyright <i className='bx bx-copyright'></i>{currentYear} CatsHardware Designed By <a href="https://CatsHardware.com/" target="_blank">CatsHardware</a> - All rights reserved.
                                </p>
                            </div>
